            ...
            <div className="p-6">
              ...
              <div className="mt-6 p-4 bg-slate-50 dark:bg-zinc-800/50 rounded-2xl border border-slate-100 dark:border-zinc-800">
                <p className="text-sm text-slate-600 dark:text-zinc-400 leading-relaxed font-medium">
                  {selectedHoliday.description || "Este é um feriado oficial. Fique atento Ã s alterações nos seus compromissos e planeje-se com antecedência para otimizar suas visitas a clientes nesta região."}
                </p>
              </div>
