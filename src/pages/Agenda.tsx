                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar space-y-2 max-h-[148px] pr-1">
                          ...
                          {dayEvents.map(event => (
                            <div 
                              ...
                              className="text-[9px] font-black p-3 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-white border border-emerald-100 dark:border-emerald-900/40 hover:border-emerald-300 transition-all cursor-pointer shadow-sm group/item flex flex-col gap-1 relative overflow-hidden"
                            >
                              ...
                              <span className="text-[7px] text-emerald-400/80 dark:text-white/60 font-bold relative z-10 uppercase shrink-0">{event.time}</span>
                            </div>
                          ))}
                        </div>
                      </>
